                ...
                children: [
                  Hero(
                    ...
                    child: Container(
                      ...
                      child: Image.network(
                        widget.thumb,
                        // headers 추가 이유 : https://gist.github.com/preinpost/941efd33dff90d9f8c7a208da40c18a9
                        headers: const {
                          "User-Agent":
              ...
              FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    return Column(
                      children: [
                        for (var episod in snapshot.data!)
                          Episode(episod: episod, webtoonId: widget.id),
                      ],
                    );
                  }
